...
namespace Books.DAL.Migrations
{
    public partial class AddData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserToBooks_Users_UserId1",
                        column: x => x.UserId1,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserToBooks_Users_UserId2",
                        column: x => x.UserId2,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "Id", "AuthorId", "AverageRating", "BookPath", "BookSeriesId", "BookStatusId", "ConfirmId", "ContentType", "DescriptionLong", "DescriptionShort", "GenreId", "ImagePath", "PublishDate", "Title" },
                values: new object[,]
                {
                    { 5, 1, 4.5, "Kapitanskaya_dochka.pdf", null, 2, 0, null, "«Капитанская дочка» принадлежит к числу произведений, которыми русские писатели 1830-х откликнулись на успех переводных романов Вальтера Скотта. Первым из исторических романов на русскую тему увидел свет «Юрий Милославский» М. Н. Загоскина (1829) (встреча Гринёва с вожатым, по мнению пушкиноведов, восходит к аналогичной сцене в романе Загоскина)", "исторический роман Александра Пушкина, действие которого происходит во время восстания Емельяна Пугачёва.", 1, "Captain's_daughter.jpg", new DateTime(1836, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Капитанская дочка" },
                    { 6, 1, 4.9000000000000004, "the_queen_of_spades.pdf", null, 2, 0, null, "В жанровом отношении повесть примыкает к таким (неоконченным) замыслам Пушкина, как «Египетские ночи», «Уединённый домик на Васильевском» и знаменитый отрывок «Гости съезжались на дачу…». Повесть неоднократно экранизирована.", "повесть Александра Сергеевича Пушкина с мистическими элементами, послужившая источником сюжета одноимённой оперы П. И. Чайковского.", 1, "The_Queen_of_Spades.jpg", new DateTime(1834, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Пиковая дама" },
                    { 7, 3, 3.7999999999999998, "idiot_-_fiedor_mikhailovich_dostoievskii.pdf", null, 1, 0, null, "Являлся одним из самых любимых произведений писателя, наиболее полно выразившим и нравственно-философскую позицию Достоевского, и его художественные принципы в 1860-х годах. Замысел романа обдумывался писателем во время пребывания за границей — в Германии и Швейцарии.", "роман Фёдора Михайловича Достоевского, впервые опубликованный в номерах журнала «Русский вестник» за 1868 год", 1, "idiot.jpeg", new DateTime(1868, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Идиот" },
                    { 8, 3, 3.6000000000000001, "karamazov_brothers.a4.pdf", null, 1, 0, null, "Роман был напечатан частями в журнале «Русский вестник». Достоевский задумывал роман как первую часть эпического романа «История Великого грешника». Произведение было окончено в ноябре 1880 года. Писатель умер через два месяца после публикации.", "последний роман Ф. М. Достоевского, который автор писал два года.", 1, "Brothers_Karamazov.jpg", new DateTime(1879, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Братья Карамазовы" },
                    { 9, 2, 4.2000000000000002, "ottsy_i_dieti_-_ivan_sierghieievich_turghieniev.pdf", null, 4, 0, null, "В обстановке «великих реформ» книга стала сенсацией и привлекла к себе всеобщее внимание, а образ главного героя Евгения Базарова был воспринят как воплощение нового, пореформенного поколения, став примером для подражания молодёжи 1860-х гг. Свойственные Базарову бескомпромиссность, отсутствие преклонения перед авторитетами и старыми истинами, приоритет полезного над прекрасным стали идеалами первого поколения пореформенной интеллигенции", "роман И. С. Тургенева, написанный в 1860—1861 годах и опубликованный в 1862 году в журнале «Русский вестник»", 1, "Fathers_and_Sons.jpg", new DateTime(1862, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Отцы и дети" },
                    { 10, 2, 4.4000000000000004, "avidreaders_ru_mumu.pdf", null, 3, 0, null, "В одном из московских домов на Остоженке живёт барыня, окружённая многочисленной челядью. Среди её слуг выделяется дворник Герасим — человек высокого роста и богатырского сложения, но глухонемой от рождения. Будучи привезённым из деревни, он долго тосковал по родным местам, но постепенно привык к городскому житью. Он усердный работник и во дворе у него всегда порядок.", "Hассказ русского писателя Ивана Сергеевича Тургенева, написанный в 1852 году.", 1, "ivan_turgenev_mumu.jpg", new DateTime(1852, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Муму" },
                    { 1, 4, 5.0, "garri_potter_and_philosofer_stone.pdf", 1, 3, 0, null, "Родителей годовалого Гарри Поттера убивает Волан-де-Морт, после чего исчезает при попытке убить самого Гарри. Поздно вечером директор школы волшебства Хогвартс Альбус Дамблдор и его заместитель Минерва МакГонагалл появляются возле дома Вернона и Петуньи Дурсль, единственных родственников Гарри.", "первый роман в серии книг про юного волшебника Гарри Поттера", 6, "Harry_Potter_and_the_Philosopher's_Stone.jpg", new DateTime(1997, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Гарри Поттер и философский камень" },
                    { 2, 4, 4.2000000000000002, "garri_potter_i_tajnaja_komnata.pdf", 1, 4, 0, null, "Книга рассказывает о втором учебном годе в школе чародейства и волшебства Хогвартс, на котором Гарри и его друзья — Рон Уизли и Гермиона Грейнджер — расследуют таинственные нападения на учеников школы, совершаемые неким «Наследником Слизерина». Объектами нападений являются ученики, среди родственников которых есть неволшебники.", "второй роман в серии книг про юного волшебника Гарри Поттера", 6, "Harry_Potter_And_The_Chamber_of_secrets.jpg", new DateTime(1998, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Гарри Поттер и тайная комната" },
                    { 3, 5, 4.2000000000000002, "2-mech-prednaznacheniya.pdf", 2, 3, 0, null, "В этом рассказе Геральт встречается с человеком по имени Борх Три Галки и двумя его телохранительницами из далёкой Зеррикании. Они отправляются по дороге, но наталкиваются на оцепление. Находящийся здесь же Лютик даёт разъяснения. В Голополье повадился летать зелёный дракон, а местный сапожник Козоед придумал, как его отравить.", "Это второе произведение из цикла «Ведьмак» как по хронологии, так и по времени написания. В этой части Геральт впервые встречает Цири и находит своё предназначение.", 6, "witcher_sword_of_destination.jpg", new DateTime(1992, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Меч Предназначения" },
                    { 4, 5, 4.4000000000000004, "1-posledneye-zhelaniye.pdf", 2, 3, 0, null, "Это первое произведение из цикла «Ведьмак» как по хронологии, так и по времени написания. От первого издания в виде книги «Ведьмак» «Последнее желание» отличается связующей серией интерлюдий «Глас рассудка» и наличием рассказов «Последнее желание» и «Край света».", "сборник рассказов писателя Анджея Сапковского в жанре фэнтези", 6, "witcher_last_wish.jpg", new DateTime(1993, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Последнее желание" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Image", "Login", "Password", "RoleId" },
                values: new object[,]
                {
                    { 1, null, "log1", "pyLGPbjshiWvbPccuMLZOQ==", 1 },
                    { 2, null, "log2", "wVctBUJNDssqZexqgq6svw==", 2 },
                    { 3, null, "log3", "Ovx5tZf4inJSjoZM+BhW0g==", 3 },
                    { 4, null, "log4", "/Ckh2QV6xE5UnvrwBIslEg==", 4 }
                });

            migrationBuilder.InsertData(
                table: "Reviews",
                columns: new[] { "Id", "BookId", "Rating", "ReviewString", "UserId" },
                values: new object[] { 1, 1, 4.5, "Интересно", 1 });

            migrationBuilder.InsertData(
                table: "Reviews",
                columns: new[] { "Id", "BookId", "Rating", "ReviewString", "UserId" },
                values: new object[] { 2, 1, 2.5, "Не очень", 1 });

            migrationBuilder.InsertData(
                table: "Reviews",
                columns: new[] { "Id", "BookId", "Rating", "ReviewString", "UserId" },
                values: new object[] { 3, 1, 4.0, "Прикольно", 4 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserToBooks_UserId1",
                table: "UserToBooks",
                column: "UserId1");

            migrationBuilder.CreateIndex(
                name: "IX_UserToBooks_UserId2",
                table: "UserToBooks",
                column: "UserId2");
        }
